    ...
    def MainLoop(self):
        ...
        while True:
            ...
            if curr_time > self.dict_time['잔고갱신및주문취소확인']:
                if (not self.dict_bool['장초전략잔고청산'] and inthmsutc < self.dict_set['코인장초전략종료시간']) or \
                        (not self.dict_set['코인장초프로세스종료'] and not self.dict_bool['장중전략잔고청산'] and inthmsutc < self.dict_set['코인장중전략종료시간']):
