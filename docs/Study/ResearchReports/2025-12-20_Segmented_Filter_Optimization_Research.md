...
```python
시간_구간 = {
    'S1_090000_090500': 90000 <= 시분초 < 90500,   # 시초가 형성기
    'S2_090500_091000': 90500 <= 시분초 < 91000,   # 초기 변동기
    'S3_091000_091500': 91000 <= 시분초 < 91500,   # 안정화기
    'S4_091500_092000': 91500 <= 시분초 < 92000    # 추세 확정기
}
```
...
**분할 근거**:
- S1 (09:00-09:05): 동시호가 해제 직후, 극심한 변동성
- S2 (09:05-09:10): 초기 추세 형성, 갭 조정
- S3 (09:10-09:15): 추세 안정화, 돌파 패턴
- S4 (09:15-09:20): 추세 확정, 모멘텀 강화

#### C. 교차 세그먼트 매트릭스

총 12개 세그먼트 생성:

| | S1 (09:00-05) | S2 (09:05-10) | S3 (09:10-15) | S4 (09:15-20) |
|---|---|---|---|---|
| **소형주** | 소형주_S1 | 소형주_S2 | 소형주_S3 | 소형주_S4 |
| **중형주** | 중형주_S1 | 중형주_S2 | 중형주_S3 | 중형주_S4 |
| **대형주** | 대형주_S1 | 대형주_S2 | 대형주_S3 | 대형주_S4 |
