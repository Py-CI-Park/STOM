...
본 문서는 STOM 주식 자동거래 시스템에서 **Study 2_T 전략**을 정의한다.

- **대상 시간 구간**: 틱 데이터 기반 (시간대별)
- **대상 종목**: 전 종목 대상
- **전략 타입**: 틱 기반 연구용 전략
- **핵심 변수**: 초당거래대금, 체결강도, 등락율
- **업데이트 이력**:
  - 초기 문서 작성: Study 2_T 전략
...
self.vars[6] = [[5.0, 10.0, 1.0], 8.0]  # 카운트 (8.0)
...
self.vars[13] = [[210, 390, 100], 300]  # 금액 (300)
self.vars[14] = [[700, 1300, 1000], 1000]  # 대금 (1000)
self.vars[15] = [[3500, 6500, 1000], 5000]  # 대금 (5000)
self.vars[16] = [[21000, 39000, 1000], 30000]  # 대금 (30000)
self.vars[17] = [[63699, 118300, 1000], 91000]  # 대금 (91000)
```
...
# 주요 변수만 최적화 대상으로 선정
# self.vars[18] 사용 - 값: 0.1
# self.vars[19] 사용 - 값: 0.7
# self.vars[20] 사용 - 값: 0.8
# self.vars[21] 사용 - 값: 1
# self.vars[22] 사용 - 값: 3
# self.vars[23] 사용 - 값: 4.0
# self.vars[24] 사용 - 값: 5
# self.vars[25] 사용 - 값: 29.5
# self.vars[26] 사용 - 값: 30
# self.vars[27] 사용 - 값: 60
```

## SOR (Sell Optimization Range)

```python
self.vars[18] = [[0.1, 0.1, 0.1], 0.1]  # 비율 (0.1)
