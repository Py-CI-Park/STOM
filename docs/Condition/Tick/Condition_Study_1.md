...
본 문서는 STOM 주식 자동거래 시스템에서 **Study 1 전략**을 정의한다.
...
self.vars[12] = [[700, 1300, 1000], 1000]  # 대금 (1000)
self.vars[13] = [[1750, 3250, 1000], 2500]  # 대금 (2500)
self.vars[14] = [[21000, 39000, 1000], 30000]  # 대금 (30000)
self.vars[15] = [[65099, 120900, 1000], 93000]  # 대금 (93000)
```
...
# 주요 변수만 최적화 대상으로 선정
# self.vars[16] 사용 - 값: 0.55
# self.vars[17] 사용 - 값: 0.7
# self.vars[18] 사용 - 값: 1
# self.vars[19] 사용 - 값: 2.0
# self.vars[20] 사용 - 값: 3.0
# self.vars[21] 사용 - 값: 4.5
# self.vars[22] 사용 - 값: 10
# self.vars[23] 사용 - 값: 29.5
# self.vars[24] 사용 - 값: 30
# self.vars[25] 사용 - 값: 60
```

## SOR (Sell Optimization Range)

```python
self.vars[16] = [[0.4, 0.7, 0.1], 0.55]  # 비율 (0.55)
self.vars[17] = [[0.5, 0.9, 0.1], 0.7]  # 비율 (0.7)
self.vars[18] = [[1, 1, 1], 1]  # 카운트 (1)
self.vars[19] = [[1.0, 2.0, 1.0], 2.0]  # 카운트 (2.0)
self.vars[20] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[21] = [[3.0, 5.0, 1.0], 4.5]  # 카운트 (4.5)
self.vars[22] = [[10, 13, 5], 10]  # 임계값 (10)
self.vars[23] = [[20.0, 38.0, 5.0], 29.5]  # 임계값 (29.5)
self.vars[24] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[25] = [[42, 78, 5], 60]  # 임계값 (60)
self.vars[26] = [[1750, 3250, 1000], 2500]  # 대금 (2500)
```
...
```python
self.vars[0] = [[0.4, 0.7, 0.1], 0.55]  # 비율 (0.55)
...
```python
self.vars[0] = [[0.4, 0.7], 0.55]  # 비율 (0.55)
...
self.vars[8] = [[2], 4]  # 카운트 (4)
self.vars[9] = [[3, 6]]  # 카운트 (5)
```
