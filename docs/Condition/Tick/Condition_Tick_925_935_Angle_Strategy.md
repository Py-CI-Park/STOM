...
- **대상 시간 구간**: 09:25:00 ~ 09:35:00 (장초 후반부 10분)
- **대상 종목**: 관심종목, 시가총액 차등 기준 (1,500억 / 2,500억 / 그 이상)
...
# self.vars[5] 사용 - 값: 0.6
# self.vars[6] 사용 - 값: 0.8
# self.vars[7] 사용 - 값: 0.9
# self.vars[8] 사용 - 값: 1
# self.vars[9] 사용 - 값: 1.05
```
...
self.vars[5] = [[0.4, 0.8, 0.1], 0.6]  # 비율 (0.6)
self.vars[6] = [[0.6, 1.0, 0.1], 0.8]  # 비율 (0.8)
self.vars[7] = [[0.6, 1.0, 0.1], 0.9]  # 비율 (0.9)
self.vars[8] = [[1, 1, 1], 1]  # 카운트 (1)
self.vars[9] = [[1.0, 1.0, 1.0], 1.05]  # 카운트 (1.05)
self.vars[10] = [[1.0, 1.0, 1.0], 1.1]  # 카운트 (1.1)
self.vars[11] = [[1.0, 1.0, 1.0], 1.2]  # 카운트 (1.2)
self.vars[12] = [[1.0, 1.0, 1.0], 1.5]  # 카운트 (1.5)
self.vars[13] = [[1.0, 2.0, 1.0], 1.8]  # 카운트 (1.8)
self.vars[14] = [[1, 2, 1], 2]  # 카운트 (2)
self.vars[15] = [[1.0, 3.0, 1.0], 2.5]  # 카운트 (2.5)
self.vars[16] = [[2, 3, 1], 3]  # 카운트 (3)
self.vars[17] = [[2, 5, 1], 4]  # 카운트 (4)
self.vars[18] = [[3, 6, 1], 5]  # 카운트 (5)
self.vars[19] = [[4, 7, 1], 6]  # 카운트 (6)
```
...
# self.vars[24] 사용 - 값: 0.65
# self.vars[25] 사용 - 값: 0.7
# self.vars[26] 사용 - 값: 0.75
...
self.vars[24] = [[0.5, 0.8, 0.1], 0.65]  # 비율 (0.65)
self.vars[25] = [[0.5, 0.9, 0.1], 0.7]  # 비율 (0.7)
self.vars[26] = [[0.5, 1.0, 0.1], 0.75]  # 비율 (0.75)
self.vars[27] = [[0.6, 1.0, 0.1], 0.8]  # 비율 (0.8)
self.vars[28] = [[0.6, 1.0, 0.1], 0.9]  # 비율 (0.9)
self.vars[29] = [[1, 1, 1], 1]  # 카운트 (1)
self.vars[30] = [[1.0, 3.0, 1.0], 2.5]  # 카운트 (2.5)
self.vars[31] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
```
...
self.vars[4] = [[0.5, 0.8, 0.1], 0.65]  # 비율 (0.65)
self.vars[5] = [[0.5, 0.9, 0.1], 0.7]  # 비율 (0.7)
...
self.vars[4] = [[0.5, 0.8], 0.65]  # 비율 (0.65)
self.vars[5] = [[0.5, 0.9], 0.7]  # 비율 (0.7)
