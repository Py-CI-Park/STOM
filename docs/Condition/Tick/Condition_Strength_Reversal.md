...
# self.vars[1] 사용 - 값: 0.9
# self.vars[2] 사용 - 값: 1
# self.vars[3] 사용 - 값: 1.015
...
self.vars[3] = [[1.0, 1.0, 1.0], 1.015]  # 카운트 (1.015)
...
self.vars[9] = [[10, 13, 5], 10]  # 임계값 (10)
self.vars[10] = [[12.0, 23.0, 5.0], 18.0]  # 임계값 (18.0)
...
self.vars[18] = [[66, 123, 5], 95]  # 임계값 (95)
...
self.vars[23] = [[1.0, 1.0, 1.0], 1.3]  # 카운트 (1.3)
...
self.vars[9] = [[1.0, 1.0, 1.0], 1.015]  # 카운트 (1.015)
```
...
self.vars[7] = [[0.6, 1.0], 0.9]  # 비율 (0.9)
