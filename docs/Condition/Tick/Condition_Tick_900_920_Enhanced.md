...
self.vars[21] = [[0.0, 2.0, 0.3], 0.3]                                 # 시가대비등락율 하한, 범위 개수: 7
...
self.vars[25] = [[0.8, 3.0, 0.3], 1.5]                                 # 회전율 하한, 범위 개수: 8
self.vars[26] = [[1, 8, 1], 3]                                         # 당일거래대금각도 하한, 범위 개수: 8
self.vars[27] = [[18, 35, 2], 25]                                      # 당일거래대금각도 상한, 범위 개수: 9
...
self.vars[35] = [[0.0, 1.5, 0.2], 0.2]                                 # 시가대비등락율 하한, 범위 개수: 8
...
self.vars[39] = [[0.5, 2.5, 0.3], 1.0]                                 # 회전율 하한, 범위 개수: 7
self.vars[40] = [[1, 6, 1], 2]                                         # 당일거래대금각도 하한, 범위 개수: 6
self.vars[41] = [[15, 30, 2], 20]                                      # 당일거래대금각도 상한, 범위 개수: 8
self.vars[42] = [[1.2, 3.5, 0.3], 2.0]                                 # 초당거래대금 배율, 범위 개수: 8
self.vars[43] = [[0.08, 0.25, 0.03], 0.12]                             # 초당매수수량 대비 매도총잔량, 범위 개수: 6
self.vars[44] = [[0.03, 0.10, 0.02], 0.05]                             # 매도총잔량 하한 배율, 범위 개수: 4
...
self.vars[53] = [[0.8, 3.0, 0.3], 1.5]                                 # 회전율 하한, 범위 개수: 8
...
self.vars[57] = [[1.2, 4.0, 0.3], 2.0]                                 # 초당거래대금 배율, 범위 개수: 10
