...
본 문서는 STOM 주식 자동거래 시스템에서 **Study 4_905 전략**을 정의한다.

- **대상 시간 구간**: 09:05:00 ~ 09:10:00
- **대상 종목**: 전 종목 대상
- **전략 타입**: 틱 기반 연구용 전략 (905 구간)
- **핵심 변수**: 초당거래대금, 체결강도, 등락율
- **업데이트 이력**:
  - 초기 문서 작성: Study 4_905 전략
...
self.vars[6] = [[4.0, 7.0, 1.0], 6.0]  # 카운트 (6.0)
...
self.vars[17] = [[63139, 117260, 1000], 90200]  # 대금 (90200)
self.vars[18] = [[63349, 117650, 1000], 90500]  # 대금 (90500)
```
...
```python
self.vars[19] = [[0.3, 0.7, 0.1], 0.5]  # 비율 (0.5)
