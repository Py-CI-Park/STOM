...
본 문서는 STOM 주식 자동거래 시스템에서 **Grok3 기반 연구 전략**을 정의한다.

- **대상 시간 구간**: 09:00:00 ~ 09:30:00 (장 초반)
- **대상 종목**: 극초단타 매매 대상 종목
- **전략 타입**: AI(Grok3) 생성 극초단타 전략 (보유시간 10~60초)
- **핵심 변수**: AI 생성 조건식, 매수 세력 급증 포착
- **업데이트 이력**:
  - 초기 문서 작성: Grok3 기반 극초단타 전략
