...
self.vars[12] = [[10.0, 19.0, 5.0], 15.0]  # 임계값 (15.0)
self.vars[13] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[14] = [[35, 65, 5], 50]  # 임계값 (50)
self.vars[15] = [[70, 130, 100], 100]  # 금액 (100)
self.vars[16] = [[210, 390, 100], 300]  # 금액 (300)
self.vars[17] = [[700, 1300, 1000], 1000]  # 대금 (1000)
self.vars[18] = [[2100, 3900, 1000], 3000]  # 대금 (3000)
self.vars[19] = [[21000, 39000, 1000], 30000]  # 대금 (30000)
```
