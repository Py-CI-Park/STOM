...
self.vars[4] = [[1.0, 1.0, 1.0], 1.1]  # 카운트 (1.1)
...
self.vars[10] = [[10.0, 19.0, 5.0], 15.0]  # 임계값 (15.0)
...
self.vars[18] = [[56, 104, 5], 80]  # 임계값 (80)
...
self.vars[28] = [[3.0, 6.0, 1.0], 5.0]  # 카운트 (5.0)
