...
self.vars[12] = [[1.0, 3.0, 1.0], 2.5]  # 카운트 (2.5)
self.vars[13] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[14] = [[3.0, 6.0, 1.0], 5.0]  # 카운트 (5.0)
self.vars[15] = [[4, 9, 1], 7]  # 카운트 (7)
self.vars[16] = [[5.0, 10.0, 1.0], 8.0]  # 카운트 (8.0)
self.vars[17] = [[10, 13, 5], 10]  # 임계값 (10)
self.vars[18] = [[10.0, 15.0, 5.0], 12.0]  # 임계값 (12.0)
self.vars[19] = [[17.0, 32.0, 5.0], 25.0]  # 임계값 (25.0)
```
...
self.vars[24] = [[0.6, 1.0, 0.1], 0.9]  # 비율 (0.9)
...
self.vars[4] = [[0.6, 1.0, 0.1], 0.9]  # 비율 (0.9)
...
self.vars[4] = [[0.6, 1.0], 0.9]  # 비율 (0.9)
