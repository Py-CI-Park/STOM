...
본 문서는 STOM 주식 자동거래 시스템에서 **오후 초반 반등 구간(13:00~14:00) 전략**을 정의한다.

- **대상 시간 구간**: 13:00:00 ~ 14:00:00 (오후 장 초반)
- **대상 종목**: 관심종목
- **전략 타입**: 점심시간 이후 반등 포착 (Afternoon Rebound)
- **핵심 변수**: 초당거래대금평균(120), 체결강도, 최저체결강도(120), 최저현재가(60), 이동평균(60)
- **업데이트 이력**:
  - 초기 문서 작성: 오후 반등 전략
...
### 매수·매도 통합 최적화 범위 - C_T_1300_1400_AR_OR
