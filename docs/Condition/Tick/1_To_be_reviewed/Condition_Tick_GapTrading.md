...
# 총 경우의 수: 3 × 3 × 3 × 3 × 3 × 3 × 3 × 3 × 3 × 2 × 3 × 3 = 354,294
```

### GA 최적화 범위 - C_T_GT_GAR

```python
# 공통
self.vars[1]  = [[1.5, 2.0, 2.5], 2.0]
self.vars[2]  = [[0.8, 1.0, 1.2], 1.0]
self.vars[3]  = [[1.2, 1.3, 1.4], 1.3]
self.vars[4]  = [[1.3, 1.5, 1.7], 1.5]

# 시가총액 < 3000
self.vars[5]  = [[1.5, 2.0, 2.5], 2.0]
self.vars[6]  = [[8.0, 9.0, 10.0, 11.0, 12.0], 10.0]
self.vars[11] = [[110, 115, 120, 125, 130], 120]

# 시가총액 >= 3000
self.vars[13] = [[1.5, 2.0, 2.5], 2.0]
self.vars[14] = [[6.0, 7.0, 8.0, 9.0, 10.0], 8.0]
self.vars[19] = [[100, 105, 110, 115, 120], 110]

# 매도
self.vars[23] = [[2.5, 3.0, 3.5], 3.0]
self.vars[24] = [[-2.5, -2.0, -1.5], -2.0]
self.vars[26] = [[0.60, 0.65, 0.70], 0.65]
```
