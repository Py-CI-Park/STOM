...
- [조건식 (Condition)](#조건식-condition)
  ...
  - [가이드라인](#가이드라인)
    - [저장 이름 규칙](#저장-이름-규칙)
- [Condition - Study\_3\_High\_Over](#condition---study_3_high_over)
  - [조건식](#조건식)
    - [매수 조건식](#매수-조건식)
    - [매도 조건식](#매도-조건식)
  - [최적화 조건식](#최적화-조건식)
...
# base_period_seconds = 600                     # 10분
base_period_seconds = current_sec - 300         # 5분 전
offset = tick_count - base_period_seconds
offset = offset if offset > 0 else 0

# 초기 10분 고가 계산
장초최고가_10 = 최고현재가(base_period_seconds, offset)  # 09:00~09:10 고가
...
# 주요 변수만 최적화 대상으로 선정
# self.vars[0] 사용 - 값: 1
# self.vars[1] 사용 - 값: 1.015
# self.vars[2] 사용 - 값: 1.5
# self.vars[3] 사용 - 값: 2
# self.vars[4] 사용 - 값: 3
# self.vars[5] 사용 - 값: 8.0
# self.vars[6] 사용 - 값: 10.0
# self.vars[7] 사용 - 값: 20.0
# self.vars[8] 사용 - 값: 30
# self.vars[9] 사용 - 값: 50
```
...
self.vars[1] = [[1.0, 1.0, 1.0], 1.015]  # 카운트 (1.015)
self.vars[2] = [[1.0, 1.0, 1.0], 1.5]  # 카운트 (1.5)
self.vars[3] = [[1, 2, 1], 2]  # 카운트 (2)
self.vars[4] = [[2, 3, 1], 3]  # 카운트 (3)
self.vars[5] = [[5.0, 10.0, 1.0], 8.0]  # 카운트 (8.0)
self.vars[6] = [[10.0, 13.0, 5.0], 10.0]  # 임계값 (10.0)
self.vars[7] = [[14.0, 26.0, 5.0], 20.0]  # 임계값 (20.0)
...
self.vars[14] = [[2520, 4680, 1000], 3600]  # 대금 (3600)
...
self.vars[18] = [[62999, 117000, 1000], 90000]  # 대금 (90000)
...
self.vars[30] = [[42, 78, 5], 60]  # 임계값 (60)
self.vars[31] = [[210, 390, 100], 300]  # 금액 (300)
```
