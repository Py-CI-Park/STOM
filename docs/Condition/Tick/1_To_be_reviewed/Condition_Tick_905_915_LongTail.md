...
**전략의 핵심 개념**:
- **시간대**: 09:05:00 ~ 09:15:00 (장 시작 5분 후 ~ 15분 후)
...
# self.vars[1] 사용 - 값: 0.4
# self.vars[2] 사용 - 값: 0.5
# self.vars[3] 사용 - 값: 1
# self.vars[4] 사용 - 값: 1.02
# self.vars[5] 사용 - 값: 1.1
# self.vars[6] 사용 - 값: 1.2
# self.vars[7] 사용 - 값: 1.3
# self.vars[8] 사용 - 값: 1.5
...
self.vars[4] = [[1.0, 1.0, 1.0], 1.02]  # 카운트 (1.02)
self.vars[5] = [[1.0, 1.0, 1.0], 1.1]  # 카운트 (1.1)
self.vars[6] = [[1.0, 1.0, 1.0], 1.2]  # 카운트 (1.2)
self.vars[7] = [[1.0, 1.0, 1.0], 1.3]  # 카운트 (1.3)
self.vars[8] = [[1.0, 1.0, 1.0], 1.5]  # 카운트 (1.5)
self.vars[9] = [[1.0, 2.0, 1.0], 2.0]  # 카운트 (2.0)
self.vars[10] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[11] = [[3.0, 6.0, 1.0], 5.0]  # 카운트 (5.0)
self.vars[12] = [[4.0, 7.0, 1.0], 6.0]  # 카운트 (6.0)
self.vars[13] = [[5.0, 10.0, 1.0], 8.0]  # 카운트 (8.0)
self.vars[14] = [[10, 13, 5], 10]  # 임계값 (10)
self.vars[15] = [[10.0, 15.0, 5.0], 12.0]  # 임계값 (12.0)
self.vars[16] = [[10.0, 19.0, 5.0], 15.0]  # 임계값 (15.0)
self.vars[17] = [[14.0, 26.0, 5.0], 20.0]  # 임계값 (20.0)
self.vars[18] = [[21, 39, 5], 30]  # 임계값 (30)
...
# self.vars[25] 사용 - 값: 0.8
# self.vars[26] 사용 - 값: 0.9
# self.vars[27] 사용 - 값: 1.0
...
self.vars[25] = [[0.6, 1.0, 0.1], 0.8]  # 비율 (0.8)
self.vars[26] = [[0.6, 1.0, 0.1], 0.9]  # 비율 (0.9)
self.vars[27] = [[1.0, 1.0, 1.0], 1.0]  # 카운트 (1.0)
...
self.vars[7] = [[0.3, 0.5, 0.1], 0.4]  # 비율 (0.4)
...
self.vars[5] = [[0.6, 1.0], 0.8]  # 비율 (0.8)
self.vars[6] = [[0.2, 0.4], 0.3]  # 비율 (0.3)
self.vars[7] = [[0.3, 0.5], 0.4]  # 비율 (0.4)
