...
본 문서는 STOM 주식 자동거래 시스템에서 **Quick Scalping Strategy**을 정의한다.
...
- **업데이트 이력**:
  - 초기 문서 작성: Quick Scalping Strategy
...
# self.vars[6] 사용 - 값: 2.2
# self.vars[7] 사용 - 값: 2.8
# self.vars[8] 사용 - 값: 6
# self.vars[9] 사용 - 값: 7
```
...
self.vars[6] = [[1.0, 2.0, 1.0], 2.2]  # 카운트 (2.2)
self.vars[7] = [[1.0, 3.0, 1.0], 2.8]  # 카운트 (2.8)
...
self.vars[15] = [[28, 52, 5], 40]  # 임계값 (40)
...
self.vars[26] = [[1.0, 1.0, 1.0], 1.4]  # 카운트 (1.4)
self.vars[27] = [[1.0, 1.0, 1.0], 1.5]  # 카운트 (1.5)
self.vars[28] = [[1.0, 2.0, 1.0], 2.0]  # 카운트 (2.0)
self.vars[29] = [[2, 3, 1], 3]  # 카운트 (3)
self.vars[30] = [[3, 6, 1], 5]  # 카운트 (5)
