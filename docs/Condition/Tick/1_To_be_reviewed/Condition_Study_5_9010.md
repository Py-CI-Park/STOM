...
본 문서는 STOM 주식 자동거래 시스템에서 **Study 5_9010 전략**을 정의한다.

- **대상 시간 구간**: 09:10:00 ~ 09:15:00
- **대상 종목**: 전 종목 대상
- **전략 타입**: 틱 기반 연구용 전략 (9010 구간)
- **핵심 변수**: 초당거래대금, 체결강도, 등락율
- **업데이트 이력**:
  - 초기 문서 작성: Study 5_9010 전략
...
self.vars[13] = [[2100, 3900, 1000], 3000]  # 대금 (3000)
...
self.vars[9] = [[4.0, 9.0, 1.0], 7.0]  # 카운트 (7.0)
```
