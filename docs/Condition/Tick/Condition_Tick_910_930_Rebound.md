...
**전략의 핵심 개념**:
- **시간대**: 09:10:00 ~ 09:30:00 (장 시작 10분 후 ~ 30분 후)
...
self.vars[1] = [[0.2, 0.5, 0.1], 0.35]  # 비율 (0.35)
...
self.vars[6] = [[0.7, 1.0, 0.1], 0.95]  # 비율 (0.95)
...
self.vars[12] = [[5.0, 10.0, 1.0], 8.0]  # 카운트 (8.0)
self.vars[13] = [[10, 13, 5], 10]  # 임계값 (10)
self.vars[14] = [[10.0, 15.0, 5.0], 12.0]  # 임계값 (12.0)
self.vars[15] = [[10.0, 19.0, 5.0], 15.0]  # 임계값 (15.0)
self.vars[16] = [[12.0, 23.0, 5.0], 18.0]  # 임계값 (18.0)
self.vars[17] = [[14, 26, 5], 20]  # 임계값 (20)
self.vars[18] = [[17.0, 32.0, 5.0], 25.0]  # 임계값 (25.0)
...
self.vars[26] = [[0.7, 1.0, 0.1], 0.97]  # 비율 (0.97)
...
self.vars[7] = [[0.2, 0.5, 0.1], 0.35]  # 비율 (0.35)
...
self.vars[7] = [[0.2, 0.5], 0.35]  # 비율 (0.35)
