...
- **전략 타입**: 시간 분할 모멘텀 + 거래대금 기반 추세 추종 전략
- **핵심 변수**: 체결강도, 초당거래대금, 일일비, 회전율, 각도 계열
...
# self.vars[1] 사용 - 값: 1
# self.vars[2] 사용 - 값: 1.01
# self.vars[3] 사용 - 값: 1.02
# self.vars[4] 사용 - 값: 1.5
# self.vars[5] 사용 - 값: 3.0
# self.vars[6] 사용 - 값: 5.0
# self.vars[7] 사용 - 값: 30
# self.vars[8] 사용 - 값: 60
# self.vars[9] 사용 - 값: 70
```
...
self.vars[2] = [[1.0, 1.0, 1.0], 1.01]  # 카운트 (1.01)
self.vars[3] = [[1.0, 1.0, 1.0], 1.02]  # 카운트 (1.02)
self.vars[4] = [[1.0, 1.0, 1.0], 1.5]  # 카운트 (1.5)
self.vars[5] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[6] = [[3.0, 6.0, 1.0], 5.0]  # 카운트 (5.0)
self.vars[7] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[8] = [[42, 78, 5], 60]  # 임계값 (60)
self.vars[9] = [[49, 91, 5], 70]  # 임계값 (70)
self.vars[10] = [[56, 104, 5], 80]  # 임계값 (80)
self.vars[11] = [[70, 130, 100], 100]  # 금액 (100)
self.vars[12] = [[84, 156, 100], 120]  # 금액 (120)
self.vars[13] = [[700, 1300, 1000], 1000]  # 대금 (1000)
self.vars[14] = [[35000, 65000, 1000], 50000]  # 대금 (50000)
self.vars[15] = [[63349, 117650, 1000], 90500]  # 대금 (90500)
self.vars[16] = [[63699, 118300, 1000], 91000]  # 대금 (91000)
self.vars[17] = [[64049, 118950, 1000], 91500]  # 대금 (91500)
self.vars[18] = [[64399, 119600, 1000], 92000]  # 대금 (92000)
```
...
# 주요 변수만 최적화 대상으로 선정
# self.vars[19] 사용 - 값: 1
# self.vars[20] 사용 - 값: 3.0
# self.vars[21] 사용 - 값: 6.0
# self.vars[22] 사용 - 값: 40
# self.vars[23] 사용 - 값: 600
# self.vars[24] 사용 - 값: 92000
```

## SOR (Sell Optimization Range)

```python
self.vars[19] = [[1, 1, 1], 1]  # 카운트 (1)
self.vars[20] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[21] = [[4.0, 7.0, 1.0], 6.0]  # 카운트 (6.0)
self.vars[22] = [[28, 52, 5], 40]  # 임계값 (40)
self.vars[23] = [[420, 780, 100], 600]  # 금액 (600)
self.vars[24] = [[64399, 119600, 1000], 92000]  # 대금 (92000)
```
...
self.vars[2] = [[4.0, 7.0, 1.0], 6.0]  # 카운트 (6.0)
self.vars[3] = [[28, 52, 5], 40]  # 임계값 (40)
self.vars[4] = [[420, 780, 100], 600]  # 금액 (600)
self.vars[5] = [[64399, 119600, 1000], 92000]  # 대금 (92000)
self.vars[6] = [[0.3, 0.7, 0.1], 0.5]  # 비율 (0.5)
self.vars[7] = [[1, 1, 1], 1]  # 카운트 (1)
self.vars[8] = [[1.0, 1.0, 1.0], 1.01]  # 카운트 (1.01)
self.vars[9] = [[1.0, 1.0, 1.0], 1.02]  # 카운트 (1.02)
```
...
self.vars[1] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[2] = [[4.0, 7.0, 1.0], 6.0]  # 카운트 (6.0)
self.vars[3] = [[28, 52], 40]  # 임계값 (40)
self.vars[4] = [[420, 780], 600]  # 금액 (600)
self.vars[5] = [[64399, 119600], 92000]  # 대금 (92000)
