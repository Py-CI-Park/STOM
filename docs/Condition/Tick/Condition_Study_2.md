...
self.vars[8] = [[35, 65, 5], 50]  # 임계값 (50)
self.vars[9] = [[70, 130, 100], 100]  # 금액 (100)
self.vars[10] = [[210, 390, 100], 300]  # 금액 (300)
self.vars[11] = [[700, 1300, 1000], 1000]  # 대금 (1000)
self.vars[12] = [[3500, 6500, 1000], 5000]  # 대금 (5000)
self.vars[13] = [[21000, 39000, 1000], 30000]  # 대금 (30000)
self.vars[14] = [[63699, 118300, 1000], 91000]  # 대금 (91000)
```
...
# 주요 변수만 최적화 대상으로 선정
# self.vars[15] 사용 - 값: 0.7
# self.vars[16] 사용 - 값: 0.8
# self.vars[17] 사용 - 값: 1
# self.vars[18] 사용 - 값: 2
# self.vars[19] 사용 - 값: 3
# self.vars[20] 사용 - 값: 4.0
# self.vars[21] 사용 - 값: 5
# self.vars[22] 사용 - 값: 15
...
```python
self.vars[15] = [[0.5, 0.9, 0.1], 0.7]  # 비율 (0.7)
self.vars[16] = [[0.6, 1.0, 0.1], 0.8]  # 비율 (0.8)
self.vars[17] = [[1, 1, 1], 1]  # 카운트 (1)
self.vars[18] = [[1, 2, 1], 2]  # 카운트 (2)
self.vars[19] = [[2, 3, 1], 3]  # 카운트 (3)
self.vars[20] = [[2.0, 5.0, 1.0], 4.0]  # 카운트 (4.0)
self.vars[21] = [[3, 6, 1], 5]  # 카운트 (5)
self.vars[22] = [[10, 19, 5], 15]  # 임계값 (15)
self.vars[23] = [[20.0, 38.0, 5.0], 29.5]  # 임계값 (29.5)
self.vars[24] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[25] = [[42, 78, 5], 60]  # 임계값 (60)
self.vars[26] = [[210, 390, 100], 300]  # 금액 (300)
```
