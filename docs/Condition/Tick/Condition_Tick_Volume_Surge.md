...
self.vars[3] = [[0.7, 1.0, 0.1], 0.95]  # 비율 (0.95)
...
self.vars[9] = [[3.0, 6.0, 1.0], 5.0]  # 카운트 (5.0)
self.vars[10] = [[4.0, 9.0, 1.0], 7.0]  # 카운트 (7.0)
self.vars[11] = [[10.0, 13.0, 5.0], 10.0]  # 임계값 (10.0)
self.vars[12] = [[10, 19, 5], 15]  # 임계값 (15)
self.vars[13] = [[14, 26, 5], 20]  # 임계값 (20)
self.vars[14] = [[20.0, 37.0, 5.0], 29.0]  # 임계값 (29.0)
self.vars[15] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[16] = [[35, 65, 5], 50]  # 임계값 (50)
self.vars[17] = [[42, 78, 5], 60]  # 임계값 (60)
...
self.vars[26] = [[0.6, 1.0, 0.1], 0.8]  # 비율 (0.8)
...
self.vars[9] = [[0.7, 1.0, 0.1], 0.95]  # 비율 (0.95)
```
...
self.vars[9] = [[0.7, 1.0], 0.95]  # 비율 (0.95)
```
