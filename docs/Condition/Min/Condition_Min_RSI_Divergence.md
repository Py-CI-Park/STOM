...
self.vars[2] = [[1.0, 1.0, 1.0], 1.05]  # 카운트 (1.05)
self.vars[3] = [[1, 2, 1], 2]  # 카운트 (2)
self.vars[4] = [[10, 13, 5], 10]  # 임계값 (10)
self.vars[5] = [[10, 19, 5], 15]  # 임계값 (15)
self.vars[6] = [[14, 26, 5], 20]  # 임계값 (20)
self.vars[7] = [[16, 29, 5], 23]  # 임계값 (23)
self.vars[8] = [[17, 32, 5], 25]  # 임계값 (25)
self.vars[9] = [[19.0, 36.0, 5.0], 28.0]  # 임계값 (28.0)
self.vars[10] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[11] = [[24, 45, 5], 35]  # 임계값 (35)
self.vars[12] = [[26, 49, 5], 38]  # 임계값 (38)
self.vars[13] = [[38, 71, 5], 55]  # 임계값 (55)
self.vars[14] = [[49, 91, 5], 70]  # 임계값 (70)
self.vars[15] = [[56, 104, 5], 80]  # 임계값 (80)
self.vars[16] = [[70, 130, 100], 100]  # 금액 (100)
self.vars[17] = [[74, 139, 100], 107]  # 금액 (107)
self.vars[18] = [[77, 143, 100], 110]  # 금액 (110)
...
# self.vars[20] 사용 - 값: 1
# self.vars[21] 사용 - 값: 2
# self.vars[22] 사용 - 값: 2.5
# self.vars[23] 사용 - 값: 5.5
# self.vars[24] 사용 - 값: 6.5
# self.vars[25] 사용 - 값: 10
# self.vars[26] 사용 - 값: 20
# self.vars[27] 사용 - 값: 29.5
# self.vars[28] 사용 - 값: 30
# self.vars[29] 사용 - 값: 68
```
...
self.vars[22] = [[1.0, 3.0, 1.0], 2.5]  # 카운트 (2.5)
self.vars[23] = [[3.0, 7.0, 1.0], 5.5]  # 카운트 (5.5)
self.vars[24] = [[4.0, 8.0, 1.0], 6.5]  # 카운트 (6.5)
self.vars[25] = [[10, 13, 5], 10]  # 임계값 (10)
self.vars[26] = [[14, 26, 5], 20]  # 임계값 (20)
self.vars[27] = [[20.0, 38.0, 5.0], 29.5]  # 임계값 (29.5)
self.vars[28] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[29] = [[47, 88, 5], 68]  # 임계값 (68)
self.vars[30] = [[49, 91, 5], 70]  # 임계값 (70)
self.vars[31] = [[50, 93, 5], 72]  # 임계값 (72)
```
...
self.vars[2] = [[1.0, 3.0, 1.0], 2.5]  # 카운트 (2.5)
self.vars[3] = [[3.0, 7.0, 1.0], 5.5]  # 카운트 (5.5)
self.vars[4] = [[4.0, 8.0, 1.0], 6.5]  # 카운트 (6.5)
self.vars[5] = [[10, 13, 5], 10]  # 임계값 (10)
self.vars[6] = [[0.3, 0.7, 0.1], 0.5]  # 비율 (0.5)
self.vars[7] = [[1, 1, 1], 1]  # 카운트 (1)
self.vars[8] = [[1.0, 1.0, 1.0], 1.05]  # 카운트 (1.05)
