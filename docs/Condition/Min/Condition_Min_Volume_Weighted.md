...
본 문서는 STOM 주식 자동거래 시스템에서 **장중 전체(09:00~15:18) 거래량 가중 전략**을 정의한다.

- **대상 시간 구간**: 09:00 ~ 15:18 (장중 전체)
- **대상 종목**: 시가총액 차등 (1,500억/3,000억 기준), 가격대 1,200원~50,000원
- **전략 타입**: 거래량 급증 + OBV 활용 (Volume Weighted)
- **핵심 변수**: 분당거래대금, OBV, AD, MFI, RSI, 체결강도, 등락율각도
- **업데이트 이력**:
  - 초기 문서 작성
