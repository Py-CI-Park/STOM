...
self.vars[16] = [[35000, 65000, 1000], 50000]  # 대금 (50000)
...
# 주요 변수만 최적화 대상으로 선정
# self.vars[18] 사용 - 값: 0.5
# self.vars[19] 사용 - 값: 0.6
...
```python
self.vars[18] = [[0.3, 0.7, 0.1], 0.5]  # 비율 (0.5)
self.vars[19] = [[0.4, 0.8, 0.1], 0.6]  # 비율 (0.6)
...
self.vars[24] = [[2, 5, 1], 4]  # 카운트 (4)
self.vars[25] = [[3, 6, 1], 5]  # 카운트 (5)
self.vars[26] = [[10, 13, 5], 10]  # 임계값 (10)
