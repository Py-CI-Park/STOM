...
self.vars[7] = [[15, 28, 5], 22]  # 임계값 (22)
self.vars[8] = [[19.0, 37.0, 5.0], 28.5]  # 임계값 (28.5)
self.vars[9] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[10] = [[31, 58, 5], 45]  # 임계값 (45)
self.vars[11] = [[33, 62, 5], 48]  # 임계값 (48)
self.vars[12] = [[42, 78, 5], 60]  # 임계값 (60)
self.vars[13] = [[45, 84, 5], 65]  # 임계값 (65)
self.vars[14] = [[49, 91, 5], 70]  # 임계값 (70)
self.vars[15] = [[50, 93, 5], 72]  # 임계값 (72)
self.vars[16] = [[59, 110, 5], 85]  # 임계값 (85)
self.vars[17] = [[70, 130, 100], 100]  # 금액 (100)
self.vars[18] = [[74, 139, 100], 107]  # 금액 (107)
...
# self.vars[20] 사용 - 값: 1
# self.vars[21] 사용 - 값: 2
# self.vars[22] 사용 - 값: 2.8
# self.vars[23] 사용 - 값: 3.0
# self.vars[24] 사용 - 값: 5
# self.vars[25] 사용 - 값: 7.0
# self.vars[26] 사용 - 값: 8.0
# self.vars[27] 사용 - 값: 20
# self.vars[28] 사용 - 값: 29.5
# self.vars[29] 사용 - 값: 60
```
...
self.vars[22] = [[1.0, 3.0, 1.0], 2.8]  # 카운트 (2.8)
self.vars[23] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[24] = [[3, 6, 1], 5]  # 카운트 (5)
self.vars[25] = [[4.0, 9.0, 1.0], 7.0]  # 카운트 (7.0)
self.vars[26] = [[5.0, 10.0, 1.0], 8.0]  # 카운트 (8.0)
self.vars[27] = [[14, 26, 5], 20]  # 임계값 (20)
self.vars[28] = [[20.0, 38.0, 5.0], 29.5]  # 임계값 (29.5)
self.vars[29] = [[42, 78, 5], 60]  # 임계값 (60)
self.vars[30] = [[49, 92, 5], 71]  # 임계값 (71)
self.vars[31] = [[51, 94, 5], 73]  # 임계값 (73)
```
...
self.vars[2] = [[1.0, 3.0, 1.0], 2.8]  # 카운트 (2.8)
self.vars[3] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[4] = [[3, 6, 1], 5]  # 카운트 (5)
self.vars[5] = [[4.0, 9.0, 1.0], 7.0]  # 카운트 (7.0)
self.vars[6] = [[0.5, 1.0, 0.1], 0.75]  # 비율 (0.75)
...
self.vars[2] = [[1.0, 3.0, 1.0], 2.8]  # 카운트 (2.8)
self.vars[3] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[4] = [[3, 6]]  # 카운트 (5)
self.vars[5] = [[4.0, 9.0, 1.0], 7.0]  # 카운트 (7.0)
self.vars[6] = [[0.5, 1.0], 0.75]  # 비율 (0.75)
