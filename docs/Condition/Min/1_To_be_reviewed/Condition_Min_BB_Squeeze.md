...
본 문서는 STOM 주식 자동거래 시스템에서 **볼린저밴드 압축 돌파 전략**을 정의한다.

- **대상 시간 구간**: 09:00 ~ 15:18 (장 전체)
- **대상 종목**: 전 종목 대상
- **전략 타입**: 볼린저밴드 압축(Squeeze) 이후 돌파 전략
- **핵심 변수**: 볼린저밴드 폭(BBU-BBL), 변동성, 돌파 강도
- **업데이트 이력**:
  - 초기 문서 작성: 볼린저밴드 압축 돌파 전략
...
# self.vars[3] 사용 - 값: 1
# self.vars[4] 사용 - 값: 1.05
# self.vars[5] 사용 - 값: 1.2
# self.vars[6] 사용 - 값: 1.3
# self.vars[7] 사용 - 값: 1.5
# self.vars[8] 사용 - 값: 1.8
# self.vars[9] 사용 - 값: 2.0
```
...
self.vars[4] = [[1.0, 1.0, 1.0], 1.05]  # 카운트 (1.05)
self.vars[5] = [[1.0, 1.0, 1.0], 1.2]  # 카운트 (1.2)
self.vars[6] = [[1.0, 1.0, 1.0], 1.3]  # 카운트 (1.3)
self.vars[7] = [[1.0, 1.0, 1.0], 1.5]  # 카운트 (1.5)
self.vars[8] = [[1.0, 2.0, 1.0], 1.8]  # 카운트 (1.8)
self.vars[9] = [[1.0, 2.0, 1.0], 2.0]  # 카운트 (2.0)
self.vars[10] = [[1.0, 3.0, 1.0], 2.5]  # 카운트 (2.5)
self.vars[11] = [[10, 13, 5], 10]  # 임계값 (10)
self.vars[12] = [[14, 26, 5], 20]  # 임계값 (20)
self.vars[13] = [[17.0, 32.0, 5.0], 25.0]  # 임계값 (25.0)
self.vars[14] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[15] = [[35, 65, 5], 50]  # 임계값 (50)
self.vars[16] = [[36, 67, 5], 52]  # 임계값 (52)
self.vars[17] = [[38, 71, 5], 55]  # 임계값 (55)
self.vars[18] = [[49, 91, 5], 70]  # 임계값 (70)
self.vars[19] = [[52, 97, 5], 75]  # 임계값 (75)
```
...
self.vars[25] = [[0.7, 1.0, 0.1], 0.95]  # 비율 (0.95)
...
self.vars[5] = [[0.7, 1.0], 0.95]  # 비율 (0.95)
