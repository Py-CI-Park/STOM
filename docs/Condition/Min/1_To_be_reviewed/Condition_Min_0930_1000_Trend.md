...
- **대상 시간 구간**: 09:30:00 ~ 10:00:00 (장초 안정화 이후 30분)
...
self.vars[14] = [[175, 325, 100], 250]  # 금액 (250)
self.vars[15] = [[350, 650, 100], 500]  # 금액 (500)
self.vars[16] = [[700, 1300, 1000], 1000]  # 대금 (1000)
self.vars[17] = [[7000, 13000, 1000], 10000]  # 대금 (10000)
self.vars[18] = [[35000, 65000, 1000], 50000]  # 대금 (50000)
self.vars[19] = [[65099, 120900, 1000], 93000]  # 대금 (93000)
```
...
# self.vars[23] 사용 - 값: 5.0
# self.vars[24] 사용 - 값: 6.0
# self.vars[25] 사용 - 값: 20
# self.vars[26] 사용 - 값: 29.5
# self.vars[27] 사용 - 값: 30
# self.vars[28] 사용 - 값: 75
# self.vars[29] 사용 - 값: 85
```
...
self.vars[23] = [[3.0, 6.0, 1.0], 5.0]  # 카운트 (5.0)
self.vars[24] = [[4.0, 7.0, 1.0], 6.0]  # 카운트 (6.0)
self.vars[25] = [[14, 26, 5], 20]  # 임계값 (20)
self.vars[26] = [[20.0, 38.0, 5.0], 29.5]  # 임계값 (29.5)
self.vars[27] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[28] = [[52, 97, 5], 75]  # 임계값 (75)
self.vars[29] = [[59, 110, 5], 85]  # 임계값 (85)
self.vars[30] = [[70000, 130000, 1000], 100000]  # 대금 (100000)
```
...
self.vars[3] = [[3.0, 6.0, 1.0], 5.0]  # 카운트 (5.0)
self.vars[4] = [[4.0, 7.0, 1.0], 6.0]  # 카운트 (6.0)
