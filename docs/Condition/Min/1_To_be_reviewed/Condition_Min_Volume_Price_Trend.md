...
self.vars[8] = [[14, 26, 5], 20]  # 임계값 (20)
self.vars[9] = [[17, 32, 5], 25]  # 임계값 (25)
self.vars[10] = [[19.0, 37.0, 5.0], 28.5]  # 임계값 (28.5)
self.vars[11] = [[21, 39, 5], 30]  # 임계값 (30)
self.vars[12] = [[28, 52, 5], 40]  # 임계값 (40)
self.vars[13] = [[30, 55, 5], 43]  # 임계값 (43)
self.vars[14] = [[51, 94, 5], 73]  # 임계값 (73)
self.vars[15] = [[52, 97, 5], 75]  # 임계값 (75)
self.vars[16] = [[70, 130, 100], 100]  # 금액 (100)
self.vars[17] = [[77, 143, 100], 110]  # 금액 (110)
self.vars[18] = [[80, 149, 100], 115]  # 금액 (115)
self.vars[19] = [[82, 153, 100], 118]  # 금액 (118)
```
...
# 주요 변수만 최적화 대상으로 선정
# self.vars[20] 사용 - 값: 0.7
# self.vars[21] 사용 - 값: 0.75
# self.vars[22] 사용 - 값: 1
# self.vars[23] 사용 - 값: 1.25
# self.vars[24] 사용 - 값: 1.3
# self.vars[25] 사용 - 값: 2
# self.vars[26] 사용 - 값: 3.0
# self.vars[27] 사용 - 값: 3.2
# self.vars[28] 사용 - 값: 6.8
# self.vars[29] 사용 - 값: 8.5
```

## SOR (Sell Optimization Range)

```python
self.vars[20] = [[0.5, 0.9, 0.1], 0.7]  # 비율 (0.7)
self.vars[21] = [[0.5, 1.0, 0.1], 0.75]  # 비율 (0.75)
self.vars[22] = [[1, 1, 1], 1]  # 카운트 (1)
self.vars[23] = [[1.0, 1.0, 1.0], 1.25]  # 카운트 (1.25)
self.vars[24] = [[1.0, 1.0, 1.0], 1.3]  # 카운트 (1.3)
self.vars[25] = [[1, 2, 1], 2]  # 카운트 (2)
self.vars[26] = [[2.0, 3.0, 1.0], 3.0]  # 카운트 (3.0)
self.vars[27] = [[2.0, 4.0, 1.0], 3.2]  # 카운트 (3.2)
self.vars[28] = [[4.0, 8.0, 1.0], 6.8]  # 카운트 (6.8)
self.vars[29] = [[5.0, 11.0, 1.0], 8.5]  # 카운트 (8.5)
self.vars[30] = [[14, 26, 5], 20]  # 임계값 (20)
...
self.vars[1] = [[0.5, 1.0, 0.1], 0.75]  # 비율 (0.75)
self.vars[2] = [[1, 1, 1], 1]  # 카운트 (1)
self.vars[3] = [[1.0, 1.0, 1.0], 1.25]  # 카운트 (1.25)
self.vars[4] = [[1.0, 1.0, 1.0], 1.3]  # 카운트 (1.3)
...
```python
self.vars[0] = [[0.5, 0.9], 0.7]  # 비율 (0.7)
self.vars[1] = [[0.5, 1.0], 0.75]  # 비율 (0.75)
