...
본 문서는 STOM 주식 자동거래 시스템에서 **다중 지표 복합 전략**을 정의한다.

- **대상 시간 구간**: 09:00 ~ 15:18 (장 전체)
- **대상 종목**: 전 종목 대상
- **전략 타입**: 다중 기술적 지표 복합 활용 전략
- **핵심 변수**: RSI, MACD, 볼린저밴드, 이동평균, 종합 신호 평가
- **업데이트 이력**:
  - 초기 문서 작성: 다중 지표 복합 전략
...
### 매수·매도 통합 최적화 범위 - C_M_MIC_OR_Min
