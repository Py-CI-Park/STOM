...
- **아이디어 조건식**: 15개 (Idea 폴더)

---

## 검토 단계별 조건식 현황

### 1️⃣ 검토 대기 중 (1_To_be_reviewed/) - 45개

초기 작성이 완료되어 검토 대기 중인 조건식입니다. 기본적인 문서 구조와 조건식 코드는 작성되어 있으나, 백테스팅 결과 검증 및 최적화 작업이 필요합니다.

**📂 위치**: `docs/Condition/Min/1_To_be_reviewed/`

**주요 조건식**:
- Condition_Bollinger_Reversal.md - 볼린저밴드 하단 반등
- Condition_Find_1_Min.md - 분봉 기반 종합 탐색 전략
- Condition_Gap_Up_Breakout.md - 갭상승 + 고가 돌파
- Condition_MACD_GoldenCross.md - MACD 골든크로스
...
**📂 위치**: `docs/Condition/Min/2_Under_review/`

**주요 조건식**:
- Condition_Stomer_Min.md - 분봉 기반 종합 전략
...
**📂 위치**: `docs/Condition/Min/3_Review_finished/`
