...
class SetMainMenu:
    ...
    def set(self):
        ...
        self.ui.pushButton_01 = self.wc.setPushbutton('', icon=self.ui.icon_stock,  color=0, click=self.ui.mnButtonClicked_00, cmd=0, shortcut='Alt+1', tip='주식 트레이더(Alt+1)')
        self.ui.pushButton_02 = self.wc.setPushbutton('', icon=self.ui.icon_coin,   color=6, click=self.ui.mnButtonClicked_00, cmd=1, shortcut='Alt+2', tip='코인 트레이더(Alt+2)')
        self.ui.pushButton_03 = self.wc.setPushbutton('', icon=self.ui.icon_stocks, color=6, click=self.ui.mnButtonClicked_00, cmd=2, shortcut='Alt+3', tip='주식 전략(Alt+3)')
        self.ui.pushButton_04 = self.wc.setPushbutton('', icon=self.ui.icon_coins,  color=6, click=self.ui.mnButtonClicked_00, cmd=3, shortcut='Alt+4', tip='코인 전략(Alt+4)')
        self.ui.pushButton_05 = self.wc.setPushbutton('', icon=self.ui.icon_live,   color=6, click=self.ui.mnButtonClicked_00, cmd=4, shortcut='Alt+5', tip='스톰 라이브(Alt+5)')
        self.ui.pushButton_06 = self.wc.setPushbutton('', icon=self.ui.icon_log,    color=6, click=self.ui.mnButtonClicked_00, cmd=5, shortcut='Alt+6', tip='로그(Alt+6)')
        self.ui.pushButton_07 = self.wc.setPushbutton('', icon=self.ui.icon_set,    color=6, click=self.ui.mnButtonClicked_00, cmd=6, shortcut='Alt+7', tip='설정(Alt+7)')
        ...
        self.ui.tt_pushButton = self.wc.setPushbutton('T', color=6, click=self.ui.mnButtonClicked_01, shortcut='Alt+T', tip='수익집계')
        self.ui.ms_pushButton = self.wc.setPushbutton('S', color=6, click=self.ui.mnButtonClicked_02, shortcut='Alt+S', tip='주식수동시작')
        ...
        self.ui.zo_pushButton = self.wc.setPushbutton('Z', color=6, click=self.ui.mnButtonClicked_03, shortcut='Alt+Z', tip='축소확대')
        self.ui.ct_pushButton = self.wc.setPushbutton('C', color=6, click=self.ui.ShowChart,          shortcut='Alt+C', tip='차트창')
        self.ui.ib_pushButton = self.wc.setPushbutton('I', color=6, click=self.ui.ShowChartDay,       shortcut='Alt+I', tip='일봉차트')
        self.ui.mb_pushButton = self.wc.setPushbutton('M', color=6, click=self.ui.ShowChartMin,       shortcut='Alt+M', tip='분봉차트')
        ...
        self.ui.bd_pushButton = self.wc.setPushbutton('B', color=6, click=self.ui.mnButtonClicked_04, shortcut='Ctrl+B', tip='백테기록삭제')
        self.ui.ad_pushButton = self.wc.setPushbutton('A', color=6, click=self.ui.mnButtonClicked_05, shortcut='Ctrl+A', tip='계정삭제')
        ...
        self.ui.zz_pushButton = self.wc.setPushbutton('E', color=6, click=self.ui.ExtendWin, shortcut='Ctrl+Shift+E', tip='전략탭확장')
        ...
        self.ui.ib_pushButton.setGeometry(8, 370, 16, 15)
        self.ui.mb_pushButton.setGeometry(23, 370, 16, 15)
        self.ui.hg_pushButton.setGeometry(8, 390, 16, 15)
        self.ui.gu_pushButton.setGeometry(23, 390, 16, 15)
        self.ui.uj_pushButton.setGeometry(8, 410, 16, 15)
        self.ui.js_pushButton.setGeometry(23, 410, 16, 15)
        self.ui.qs_pushButton.setGeometry(8, 430, 16, 15)
        self.ui.bs_pushButton.setGeometry(23, 430, 16, 15)
        ...
        self.ui.c2_pushButton.setGeometry(5, 490, 35, 15)
        self.ui.sf_pushButton.setGeometry(5, 505, 35, 15)
        self.ui.bb_pushButton.setGeometry(8, 525, 16, 15)
        self.ui.od_pushButton.setGeometry(23, 525, 16, 15)
        self.ui.vv_pushButton.setGeometry(8, 545, 16, 15)
