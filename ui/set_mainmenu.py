...
class SetMainMenu:
    ...
    def set(self):
        ...
        self.ui.ic_pushButton = self.wc.setPushbutton('I', color=6, click=self.ui.ShowICOS,           shortcut='Alt+I', tip='ICOS 반복최적화')
        ...
        self.ui.ic_pushButton.setGeometry(8, 430, 31, 15)
        ...
        self.ui.zz_pushButton.setGeometry(8, 545, 16, 15)
        self.ui.progressBarrr.setGeometry(6, 565, 35, 192)
