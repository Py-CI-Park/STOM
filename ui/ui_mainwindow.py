...
class MainWindow(QMainWindow):
    def __init__(self, auto_run_):
        ...
        self.update_textedit    = UpdateTextedit(self, self.qlist)
        self.update_tablewidget = UpdateTablewidget(self, self.qlist)
    ...
    def AutoBackSchedule(self, gubun):     auto_back_schedule(self, gubun, self.soundQ, self.teleQ)
    def VideoWidgetClose(self, state):     video_widget_close(self, state)
    def StomliveScreenshot(self, cmd):     stom_live_screenshot(self, cmd, self.teleQ)
    # =================================================================================================================
    ...
    @pyqtSlot(int)
    def CellClicked_02(self, row):      cell_clicked_02(self, row, self.wdzservQ)
    @pyqtSlot(int)
    def CellClicked_03(self, row):      cell_clicked_03(self, row, self.ctraderQ)
    @pyqtSlot(int)
    ...
    @pyqtSlot(int)
    def CellClicked_07(self, row):      cell_clicked_07(self, row, self.chartQ)
    @pyqtSlot(int)
    def CellClicked_08(self, row):      cell_clicked_08(self, row)
    @pyqtSlot(int, int)
    def CellClicked_09(self, row, col): cell_clicked_09(self, row, col, self.windowQ)
    @pyqtSlot(int, int)
    def CellClicked_10(self, row, col): cell_clicked_10(self, row, col)
    def CellClicked_11(self):           cell_clicked_11(self)
    # =================================================================================================================
    def ReturnPress_01(self): return_press_01(self, self.chartQ)
    def ReturnPress_02(self): return_press_02(self, self.teleQ)
    # =================================================================================================================
    ...
    def ShowDialogWeb(self, show, code):                            show_dialog_web(self, show, code, self.webcQ)
    ...
    def ShowDialogChart(self, real, coin, code, tickcount=None, searchdate=None, starttime=None, endtime=None, detail=None, buytimes=None):
        show_dialog_chart(self, real, coin, code, self.proc_chart, self.cstgQ, self.wdzservQ, self.chartQ, tickcount, searchdate, starttime, endtime, detail, buytimes)
    ...
    def dbButtonClicked_04(self): dbbutton_clicked_04(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_05(self): dbbutton_clicked_05(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_06(self): dbbutton_clicked_06(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_07(self): dbbutton_clicked_07(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_08(self): dbbutton_clicked_08(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_09(self): dbbutton_clicked_09(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_10(self): dbbutton_clicked_10(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_11(self): dbbutton_clicked_11(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_12(self): dbbutton_clicked_12(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_13(self): dbbutton_clicked_13(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_14(self): dbbutton_clicked_14(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_15(self): dbbutton_clicked_15(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_16(self): dbbutton_clicked_16(self, self.windowQ, self.queryQ, self.proc_query)
    def dbButtonClicked_17(self): dbbutton_clicked_17(self, self.windowQ, self.queryQ, self.proc_query)
    ...
    # =================================================================================================================
    def odButtonClicked_01(self): odbutton_clicked_01(self, self.ctraderQ, self.wdzservQ)
    def odButtonClicked_02(self): odbutton_clicked_02(self, self.ctraderQ, self.wdzservQ)
    def odButtonClicked_03(self): odbutton_clicked_03(self, self.ctraderQ)
    def odButtonClicked_04(self): odbutton_clicked_04(self, self.ctraderQ)
    def odButtonClicked_05(self): odbutton_clicked_05(self, self.ctraderQ)
    def odButtonClicked_06(self): odbutton_clicked_06(self, self.ctraderQ)
    ...
    def BackBench(self):          back_bench(self, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def sdButtonClicked_01(self): sdbutton_clicked_01(self)
    def sdButtonClicked_02(self): sdbutton_clicked_02(self, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def sdButtonClicked_03(self): sdbutton_clicked_03(self)
    def sdButtonClicked_04(self): sdbutton_clicked_04(self)
    def sdButtonClicked_05(self): sdbutton_clicked_05(self, self.proc_query, self.queryQ)
    # =================================================================================================================
    def mnButtonClicked_01(self, index):            mnbutton_c_clicked_01(self, index)
    def mnButtonClicked_02(self):                   mnbutton_c_clicked_02(self)
    def mnButtonClicked_03(self, stocklogin=False): mnbutton_c_clicked_03(self, self.wdzservQ, self.soundQ, stocklogin)
    def mnButtonClicked_04(self):                   mnbutton_c_clicked_04(self)
    def mnButtonClicked_05(self):                   mnbutton_c_clicked_05(self, self.proc_query, self.queryQ)
    def mnButtonClicked_06(self):                   mnbutton_c_clicked_06(self, self.proc_query, self.queryQ)
    # =================================================================================================================
    ...
    def svjbButtonClicked_02(self): svjb_button_clicked_02(self, self.proc_query, self.queryQ)
    def svjbButtonClicked_03(self): svjb_button_clicked_03(self)
    def svjbButtonClicked_04(self): svjb_button_clicked_04(self, self.wdzservQ)
    ...
    def svjbButtonClicked_12(self): svjb_button_clicked_12(self, self.wdzservQ)
    # =================================================================================================================
    ...
    def svjButtonClicked_11(self): svj_button_clicked_11(self, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def svjButtonClicked_12(self): svj_button_clicked_12(self, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ)
    def svjButtonClicked_13(self): svj_button_clicked_13(self)
    def svjButtonClicked_14(self, back_name): svj_button_clicked_14(self, back_name, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def svjButtonClicked_15(self, back_name): svj_button_clicked_15(self, back_name, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def svjButtonClicked_16(self, back_name): svj_button_clicked_16(self, back_name, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ)
    def svjButtonClicked_17(self, back_name): svj_button_clicked_17(self, back_name, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ)
    ...
    def svjButtonClicked_23(self): svj_button_clicked_23(self, self.windowQ, self.backQ, self.totalQ)
    def svjButtonClicked_24(self): svj_button_clicked_24(self, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def svjButtonClicked_25(self): svj_button_clicked_25(self)
    # =================================================================================================================
    def svjsButtonClicked_01(self): svjs_button_clicked_01(self)
    def svjsButtonClicked_02(self): svjs_button_clicked_02(self, self.proc_query, self.queryQ)
    def svjsButtonClicked_03(self): svjs_button_clicked_03(self)
    def svjsButtonClicked_04(self): svjs_button_clicked_04(self, self.wdzservQ)
    ...
    def svjsButtonClicked_14(self): svjs_button_clicked_14(self, self.wdzservQ)
    # =================================================================================================================
    def svcButtonClicked_01(self): svc_button_clicked_01(self)
    def svcButtonClicked_02(self): svc_button_clicked_02(self, self.proc_query, self.queryQ)
    def svcButtonClicked_03(self): svc_button_clicked_03(self)
    def svcButtonClicked_04(self): svc_button_clicked_04(self, self.proc_query, self.queryQ)
    def svcButtonClicked_05(self): svc_button_clicked_05(self)
    def svcButtonClicked_06(self): svc_button_clicked_06(self, self.proc_query, self.queryQ)
    def svcButtonClicked_07(self): svc_button_clicked_07(self)
    def svcButtonClicked_08(self): svc_button_clicked_08(self, self.proc_query, self.queryQ)
    def svcButtonClicked_09(self): svc_button_clicked_09(self, self.proc_query, self.queryQ)
    ...
    def cvjbButtonClicked_04(self): cvjb_button_clicked_04(self, self.cstgQ)
    ...
    def cvjbButtonClicked_12(self): cvjb_button_clicked_12(self, self.cstgQ)
    # =================================================================================================================
    ...
    def cvjButtonClicked_11(self): cvj_button_clicked_11(self, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def cvjButtonClicked_12(self): cvj_button_clicked_12(self, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ)
    def cvjButtonClicked_13(self): cvj_button_clicked_13(self)
    def cvjButtonClicked_14(self, back_name): cvj_button_clicked_14(self, back_name, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def cvjButtonClicked_15(self, back_name): cvj_button_clicked_15(self, back_name, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def cvjButtonClicked_16(self, back_name): cvj_button_clicked_16(self, back_name, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ)
    def cvjButtonClicked_17(self, back_name): cvj_button_clicked_17(self, back_name, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ)
    ...
    def cvjButtonClicked_23(self): cvj_button_clicked_23(self, self.windowQ, self.backQ, self.totalQ)
    def cvjButtonClicked_24(self): cvj_button_clicked_24(self, self.windowQ, self.backQ, self.soundQ, self.totalQ, self.liveQ, self.teleQ)
    def cvjButtonClicked_25(self): cvj_button_clicked_25(self)
    # =================================================================================================================
    def cvjsButtonClicked_01(self): cvjs_button_clicked_01(self)
    def cvjsButtonClicked_02(self): cvjs_button_clicked_02(self, self.proc_query, self.queryQ)
    def cvjsButtonClicked_03(self): cvjs_button_clicked_03(self)
    def cvjsButtonClicked_04(self): cvjs_button_clicked_04(self, self.cstgQ)
    ...
    def cvjsButtonClicked_14(self): cvjs_button_clicked_14(self, self.cstgQ)
    # =================================================================================================================
    def cvcButtonClicked_01(self): cvc_button_clicked_01(self)
    def cvcButtonClicked_02(self): cvc_button_clicked_02(self, self.proc_query, self.queryQ)
    def cvcButtonClicked_03(self): cvc_button_clicked_03(self)
    def cvcButtonClicked_04(self): cvc_button_clicked_04(self, self.proc_query, self.queryQ)
    def cvcButtonClicked_05(self): cvc_button_clicked_05(self)
    def cvcButtonClicked_06(self): cvc_button_clicked_06(self, self.proc_query, self.queryQ)
    def cvcButtonClicked_07(self): cvc_button_clicked_07(self)
    def cvcButtonClicked_08(self): cvc_button_clicked_08(self, self.proc_query, self.queryQ)
    def cvcButtonClicked_09(self): cvc_button_clicked_09(self, self.proc_query, self.queryQ)
    ...
    def cvaButtonClicked_02(self): cva_button_clicked_02(self, self.proc_query, self.queryQ)
    def cvoButtonClicked_01(self): cvo_button_clicked_01(self)
    def cvoButtonClicked_02(self): cvo_button_clicked_02(self, self.proc_query, self.queryQ)
    ...
    def ctButtonClicked_03(self): ct_button_clicked_03(self, self.windowQ, self.wdzservQ, self.cstgQ)
    ...
    def sjButtonClicked_09(self): sj_button_cicked_09(self, self.proc_query, self.queryQ)
    def sjButtonClicked_10(self): sj_button_cicked_10(self, self.proc_query, self.queryQ)
    def sjButtonClicked_11(self): sj_button_cicked_11(self, self.proc_query, self.queryQ)
    def sjButtonClicked_12(self): sj_button_cicked_12(self, self.proc_query, self.queryQ, self.teleQ)
    def sjButtonClicked_13(self): sj_button_cicked_13(self, self.proc_query, self.queryQ)
    def sjButtonClicked_14(self): sj_button_cicked_14(self, self.proc_query, self.queryQ)
    def sjButtonClicked_15(self): sj_button_cicked_15(self, self.proc_query, self.queryQ)
    def sjButtonClicked_16(self): sj_button_cicked_16(self, self.proc_query, self.queryQ)
    ...
    def sjButtonClicked_23(self): sj_button_cicked_23(self, self.proc_query, self.queryQ)
    def sjButtonClicked_24(self): sj_button_cicked_24(self, self.proc_query, self.queryQ)
    def sjButtonClicked_25(self): sj_button_cicked_25(self, self.proc_query, self.queryQ)
    def sjButtonClicked_26(self): sj_button_cicked_26(self, self.proc_query, self.queryQ)
    def sjButtonClicked_27(self): sj_button_cicked_27(self)
    def sjButtonClicked_28(self): sj_button_cicked_28(self, self.proc_query, self.queryQ)
