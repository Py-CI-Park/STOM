...
class SetCoinBack:
    ...
    # =================================================================================================================
        ...
        self.ui.cvj_pushButton_15 = self.wc.setPushbutton('전략 편집기', box=self.ui.cs_tab, click=self.ui.cvjButtonClicked_09, color=5, tip='단축키(Alt+1)')
        self.ui.cvj_pushButton_11 = self.wc.setPushbutton('최적화 편집기', box=self.ui.cs_tab, click=self.ui.cvjButtonClicked_05, color=4, tip='단축키(Alt+2)')
        self.ui.cvj_pushButton_09 = self.wc.setPushbutton('테스트 편집기', box=self.ui.cs_tab, click=self.ui.cvjButtonClicked_01, color=4, tip='단축키(Alt+3)')
        self.ui.cvj_pushButton_07 = self.wc.setPushbutton('전진분석', box=self.ui.cs_tab, click=self.ui.cvjButtonClicked_02, color=4, tip='단축키(Alt+4)')
        self.ui.cvj_pushButton_08 = self.wc.setPushbutton('GA 편집기', box=self.ui.cs_tab, click=self.ui.cvjButtonClicked_03, color=4, tip='단축키(Alt+5)')
        self.ui.cvj_pushButton_10 = self.wc.setPushbutton('조건 편집기', box=self.ui.cs_tab, click=self.ui.cvjButtonClicked_10, color=4, tip='단축키(Alt+6)')
        self.ui.cvj_pushButton_12 = self.wc.setPushbutton('범위 편집기', box=self.ui.cs_tab, click=self.ui.cvjButtonClicked_04, color=4, tip='단축키(Alt+7)')
        self.ui.cvj_pushButton_16 = self.wc.setPushbutton('변수 편집기', box=self.ui.cs_tab, click=self.ui.cvjButtonClicked_06, color=4, tip='단축키(Alt+8)')
