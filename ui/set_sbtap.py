...
class SetStockBack:
    ...
    # =================================================================================================================
        ...
        self.ui.svj_pushButton_03 = self.wc.setPushbutton('백파인더 예제', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_13, color=3)
        ...
        self.ui.stock_backte_list = [
            ...
            self.ui.svj_pushButton_03, self.ui.svjs_comboBoxx_01, self.ui.svjs_lineEditt_01, self.ui.svjs_pushButon_01,
            self.ui.svjs_pushButon_02, self.ui.svjs_pushButon_03, self.ui.svjs_pushButon_04, self.ui.svjs_pushButon_05,
            self.ui.svjs_pushButon_06, self.ui.svjs_pushButon_07, self.ui.svjs_pushButon_08, self.ui.svjs_pushButon_09,
            self.ui.svjs_pushButon_10, self.ui.svjs_pushButon_11, self.ui.svjs_pushButon_12, self.ui.svjs_pushButon_13,
            self.ui.svjs_pushButon_14
        ]
    ...
    # =================================================================================================================
        ...
        self.ui.svj_pushButton_04 = self.wc.setPushbutton('테스트 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_01, color=4, tip='단축키(Ctrl+4)')
        self.ui.svj_pushButton_05 = self.wc.setPushbutton('전진분석', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_02, color=4, tip='단축키(Ctrl+5)')
        self.ui.svj_pushButton_06 = self.wc.setPushbutton('GA 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_03, color=4, tip='단축키(Ctrl+3)')
        self.ui.svj_pushButton_07 = self.wc.setPushbutton('범위 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_04, color=4, tip='단축키(Ctrl+6)')
        self.ui.svj_pushButton_08 = self.wc.setPushbutton('최적화 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_05, color=4, tip='단축키(Ctrl+2)')
        self.ui.svj_pushButton_09 = self.wc.setPushbutton('변수 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_06, color=4, tip='단축키(Ctrl+7)')
        self.ui.svj_pushButton_10 = self.wc.setPushbutton('백테스트 로그', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_07, color=4, tip='단축키(Ctrl+9)')
        self.ui.svj_pushButton_11 = self.wc.setPushbutton('상세기록', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_08, color=4, tip='단축키(Ctrl+0)')
        self.ui.svj_pushButton_12 = self.wc.setPushbutton('전략 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_09, color=5, tip='단축키(Ctrl+1)')
        self.ui.svj_pushButton_13 = self.wc.setPushbutton('조건 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_10, color=4, tip='단축키(Ctrl+8)')

        self.ui.stock_editer_list = [
            self.ui.svj_pushButton_04, self.ui.svj_pushButton_05, self.ui.svj_pushButton_06, self.ui.svj_pushButton_07,
            self.ui.svj_pushButton_08, self.ui.svj_pushButton_09, self.ui.svj_pushButton_10, self.ui.svj_pushButton_11,
            self.ui.svj_pushButton_12, self.ui.svj_pushButton_13
        ]
    ...
    # =================================================================================================================
        ...
        self.ui.svc_pushButton_05 = self.wc.setPushbutton('기준값 제한설정', box=self.ui.ss_tab, click=self.ui.svcButtonClicked_11, tip='백테 결과값 중 특정 수치를 만족하지 못하면\n기준값을 0으로 도출하도록 설정한다.')
    ...
    # =================================================================================================================
        ...
        self.ui.svc_pushButton_06 = self.wc.setPushbutton('분할 검증 최적화', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_14, color=2, tip='학습기간만 선택하여 진행되며 설정한 학습기간의\n데이터를 일자기준으로 마지막 일자가 홀수일 경우\n학습(홀수일자), 검증(짝수일자)으로 분류하여 최적화한다.\n마지막 일자가 짝수일 경우 반대로 분류한다.')
        self.ui.svc_pushButton_07 = self.wc.setPushbutton('교차 검증 최적화', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_15, color=2, tip='학습기간과 검증기간을 선택하여 진행되며\n검증 최적화는 1회만 검증을 하지만, 교차검증은\n검증기간을 학습기간 / 검증기간 + 1만큼 교차분류하여 최적화한다.')
        self.ui.svc_pushButton_08 = self.wc.setPushbutton('검증 최적화', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_16, color=2, tip='학습기간과 검증기간을 선택하여 진행되며\n데이터의 시계열 순서대로 학습, 검증기간을 분류하여 최적화한다.')
    ...
    # =================================================================================================================
        ...
        self.ui.stock_optimz_list = [
            ...
            self.ui.svc_pushButton_13, self.ui.svc_pushButton_14
        ]
    ...
    # =================================================================================================================
        ...
        self.ui.svc_pushButton_15 = self.wc.setPushbutton('분할 검증 최적화 테스트', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_17, color=2, tip='학습기간과 확인기간을 선택하여 진행되며\n분할 검증 최적화로 구한 최적값을 확인기간에 대하여 테스트한다.')
        self.ui.svc_pushButton_16 = self.wc.setPushbutton('교차 검증 최적화 테스트', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_18, color=2, tip='학습기간, 검증기간, 확인기간을 선택하여 진행되며\n교차 검증 최적화로 구한 최적값을 확인기간에 대하여 테스트한다.')
        self.ui.svc_pushButton_17 = self.wc.setPushbutton('검증 최적화 테스트', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_19, color=2, tip='학습기간, 검증기간, 확인기간을 선택하여 진행되며\n검증 최적화로 구한 최적값을 확인기간에 대하여 테스트한다.')
        ...
        self.ui.stock_optest_list = [
            ...
            self.ui.svc_lineEdittt_02, self.ui.svc_pushButton_03, self.ui.svc_pushButton_04
        ]
    ...
    # =================================================================================================================
        ...
        self.ui.svc_pushButton_18 = self.wc.setPushbutton('분할 검증 최적화 전진분석', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_20, color=2, tip='학습기간, 확인기간, 전체기간을 선택하여 진행되며\n분할 검증 최적화 테스트를 전진분석한다.')
        self.ui.svc_pushButton_19 = self.wc.setPushbutton('교차 검증 최적화 전진분석', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_21, color=2, tip='학습기간, 검증기간, 확인기간, 전체기간을 선택하여 진행되며\n교차 검증 최적화 테스트를 전진분석한다.')
        self.ui.svc_pushButton_20 = self.wc.setPushbutton('검증 최적화 전진분석', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_22, color=2, tip='학습기간, 검증기간, 확인기간, 전체기간을 선택하여 진행되며\n검증 최적화 테스트를 전진분석한다.')
        ...
        self.ui.stock_rwftvd_list = [
            ...
            self.ui.svjb_dateEditt_01, self.ui.svjb_dateEditt_02
        ]
    ...
    # =================================================================================================================
        ...
        self.ui.sva_pushButton_01 = self.wc.setPushbutton('교차 검증 GA최적화', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_23, color=2, tip='학습기간과 검증기간을 선택하여 진행되며\n교차 검증 GA최적화한다.')
        self.ui.sva_pushButton_02 = self.wc.setPushbutton('검증 GA최적화', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_24, color=2, tip='학습기간과 검증기간을 선택하여 진행되며\n검증 GA최적화한다.')
        self.ui.sva_pushButton_03 = self.wc.setPushbutton('GA최적화', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_25, color=2, tip='학습기간을 선택하여 진행되며\n데이터 전체를 사용하여 GA최적화한다.')
    ...
    # =================================================================================================================
        ...
        self.ui.svc_pushButton_23 = self.wc.setPushbutton('범위 변수 키값 재정렬', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_32, color=2, visible=False, tip='범위 변수 self.vars의 키값을 재정렬한다.')
    ...
    # =================================================================================================================
        ...
        self.ui.svc_pushButton_26 = self.wc.setPushbutton('변수(self.vars) 키값 재정렬', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_33, color=2, visible=False, tip='변수 self.vars의 키값을 재정렬한다.')
    ...
    # =================================================================================================================
        ...
        self.ui.svo_pushButton_05 = self.wc.setPushbutton('교차 검증 조건 최적화', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_29, color=2, tip='학습기간과 검증기간을 선택하여 진행되며\n교차 검증 조건최적화한다.')
        self.ui.svo_pushButton_06 = self.wc.setPushbutton('검증 조건 최적화', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_30, color=2, tip='학습기간과 검증기간을 선택하여 진행되며\n검증 조건최적화한다.')
        self.ui.svo_pushButton_07 = self.wc.setPushbutton('조건 최적화', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_31, color=2, tip='학습기간을 선택하여 진행되며\n데이터 전체를 사용하여 조건최적화한다.')
    ...
    # =================================================================================================================
        ...
        self.ui.ss_textEditttt_02.setGeometry(7, 478, 1000, 270)
        self.ui.ss_textEditttt_03.setGeometry(509, 10, 497, 463)
        self.ui.ss_textEditttt_04.setGeometry(509, 478, 497, 270)
        self.ui.ss_textEditttt_05.setGeometry(659, 10, 347, 738)
        self.ui.ss_textEditttt_06.setGeometry(659, 10, 347, 738)
        self.ui.ss_textEditttt_07.setGeometry(7, 10, 497, 738)
        self.ui.ss_textEditttt_08.setGeometry(509, 10, 497, 738)
        ...
        self.ui.svj_pushButton_04.setGeometry(1182, 335, 80, 30)
        self.ui.svj_pushButton_05.setGeometry(1267, 335, 80, 30)
        self.ui.svj_pushButton_06.setGeometry(1182, 370, 80, 30)
        self.ui.svj_pushButton_07.setGeometry(1267, 370, 80, 30)
        self.ui.svj_pushButton_08.setGeometry(1182, 405, 80, 30)
        self.ui.svj_pushButton_09.setGeometry(1267, 405, 80, 30)
        self.ui.svj_pushButton_10.setGeometry(1012, 440, 80, 30)
        self.ui.svj_pushButton_11.setGeometry(1097, 440, 80, 30)
        self.ui.svj_pushButton_12.setGeometry(1182, 440, 80, 30)
        ...
        self.ui.svc_pushButton_05.setGeometry(1247, 220, 100, 25)

        self.ui.svc_pushButton_06.setGeometry(1012, 335, 165, 30)
        self.ui.svc_pushButton_07.setGeometry(1012, 370, 165, 30)
        self.ui.svc_pushButton_08.setGeometry(1012, 405, 165, 30)
        ...
        self.ui.svc_pushButton_15.setGeometry(1012, 335, 165, 30)
        self.ui.svc_pushButton_16.setGeometry(1012, 370, 165, 30)
        self.ui.svc_pushButton_17.setGeometry(1012, 405, 165, 30)

        self.ui.svc_pushButton_18.setGeometry(1012, 335, 165, 30)
        self.ui.svc_pushButton_19.setGeometry(1012, 370, 165, 30)
        self.ui.svc_pushButton_20.setGeometry(1012, 405, 165, 30)
