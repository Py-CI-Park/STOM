...
class SetStockBack:
    ...
    # =================================================================================================================
        ...
        self.ui.svj_pushButton_04 = self.wc.setPushbutton('전진분석', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_02, color=4, tip='단축키(Ctrl+4)')
        self.ui.svj_pushButton_05 = self.wc.setPushbutton('GA 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_03, color=4, tip='단축키(Ctrl+5)')
        self.ui.svj_pushButton_06 = self.wc.setPushbutton('테스트 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_01, color=4, tip='단축키(Ctrl+3)')
        self.ui.svj_pushButton_07 = self.wc.setPushbutton('조건 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_10, color=4, tip='단축키(Ctrl+6)')
        ...
        self.ui.svj_pushButton_09 = self.wc.setPushbutton('범위 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_04, color=4, tip='단축키(Ctrl+7)')
        ...
        self.ui.svj_pushButton_13 = self.wc.setPushbutton('변수 편집기', box=self.ui.ss_tab, click=self.ui.svjButtonClicked_06, color=4, tip='단축키(Ctrl+8)')
