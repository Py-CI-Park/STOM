...
class SetSetupTap:
    ...
    def set(self):
        ...
        self.ui.sj_set_pButton_01 = self.wc.setPushbutton('로딩', box=self.ui.sj_tab, click=self.ui.sjButtonClicked_28)
        self.ui.sj_set_pButton_02 = self.wc.setPushbutton('설정', box=self.ui.sj_tab, click=self.ui.sjButtonClicked_29)
        self.ui.sj_set_pButton_03 = self.wc.setPushbutton('삭제', box=self.ui.sj_tab, click=self.ui.sjButtonClicked_30)
        self.ui.sj_set_liEditt_01 = self.wc.setLineedit(self.ui.sj_tab, style=style_bc_dk)
        self.ui.sj_set_pButton_04 = self.wc.setPushbutton('저장', box=self.ui.sj_tab, click=self.ui.sjButtonClicked_31)
        ...
        self.ui.sj_main_cheBox_08 = self.wc.setCheckBox('최근거래대금순위', self.ui.sj_bs_groupBox_01, changed=self.ui.CheckboxChanged_19, tip='우측 빈칸 두곳에 집계시간(분) 및 선정등수를 입력하여 사용한다.')
