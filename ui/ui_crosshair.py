...
class CrossHair:
    ...
    def crosshair(self, real, coin_, main_pg, sub_pg1, sub_pg2, sub_pg3, sub_pg4, sub_pg5, sub_pg6, sub_pg7, sub_pg8=None,
        ...
        try:
            ...
            main_pg.addItem(self.ui.ctpg_tik_labels[0])
            sub_pg1.addItem(self.ui.ctpg_tik_labels[1])
            sub_pg2.addItem(self.ui.ctpg_tik_labels[2])
            sub_pg3.addItem(self.ui.ctpg_tik_labels[3])
            sub_pg4.addItem(self.ui.ctpg_tik_labels[4])
            sub_pg5.addItem(self.ui.ctpg_tik_labels[5])
            sub_pg6.addItem(self.ui.ctpg_tik_labels[6])
            sub_pg7.addItem(self.ui.ctpg_tik_labels[7])
            if sub_pg8 is not None:
                ...
                sub_pg8.addItem(self.ui.ctpg_tik_labels[8])
                sub_pg9.addItem(self.ui.ctpg_tik_labels[9])
                sub_pg10.addItem(self.ui.ctpg_tik_labels[10])
                sub_pg11.addItem(self.ui.ctpg_tik_labels[11])
            if sub_pg12 is not None:
                ...
                sub_pg12.addItem(self.ui.ctpg_tik_labels[12])
                sub_pg13.addItem(self.ui.ctpg_tik_labels[13])
                sub_pg14.addItem(self.ui.ctpg_tik_labels[14])
                sub_pg15.addItem(self.ui.ctpg_tik_labels[15])
        except:
            pass
