...
:gotAdmin
    ...
    echo ========================================
    echo STOM V1 - Stock Trading Mode (가상환경)
    echo ========================================
    echo 32-bit Python: %PYTHON_32BIT%
    echo 64-bit Python: %PYTHON_64BIT%
    echo.

    echo [1/2] 데이터베이스 검증 중 (64비트)...
    ...
    echo [2/2] STOM V1 - Stock Mode 실행 중...
    echo [정보] Kiwoom 프로세스는 32비트 Python으로 자동 실행됩니다.
